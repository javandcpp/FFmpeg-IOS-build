...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --as='xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-nonfree --enable-gpl --enable-nonfree --enable-libx264 --enable-nonfree --enable-libfdk-aac --extra-cflags='-arch armv7 -mios-version-min=8.0 -fembed-bitcode -I/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/x264-ios-fat/include -I/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/fdk-aac-ios-fat/include' --extra-ldflags='-arch armv7 -mios-version-min=8.0 -fembed-bitcode -L/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/x264-ios-fat/lib -L/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/fdk-aac-ios-fat/lib' --prefix=/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/thin/armv7
...
SRC_PATH=/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/ffmpeg-4.1
SRC_LINK=src
...
CFLAGS=  -arch armv7 -mios-version-min=8.0 -fembed-bitcode -I/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/x264-ios-fat/include -I/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/fdk-aac-ios-fat/include -march=armv7-a -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -mthumb -pthread  -I/usr/local/Cellar/x264/r2854/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch armv7 -mios-version-min=8.0 -fembed-bitcode -I/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/x264-ios-fat/include -I/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/fdk-aac-ios-fat/include -march=armv7-a -fPIC -Qunused-arguments
...
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -mios-version-min=8.0 -fembed-bitcode -L/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/x264-ios-fat/lib -L/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/fdk-aac-ios-fat/lib  -march=armv7-a -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-liconv -lm -lz -framework AudioToolbox -lfdk-aac -L/usr/local/Cellar/x264/r2854/lib -lx264 -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
