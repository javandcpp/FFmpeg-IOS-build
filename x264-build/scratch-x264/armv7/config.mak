SRCPATH=../../x264
prefix=/Users/huaweichang/Downloads/FFmpeg-ios-master/FFmpeg-iOS-build-script-master/x264-build/thin-x264/armv7
exec_prefix=${prefix}
...
ASFLAGS= -I. -I$(SRCPATH) -arch armv7 -fembed-bitcode -mios-version-min=7.0 -DPREFIX -DPIC -c -DSTACK_ALIGNMENT=4 -DPIC
RC=
RCFLAGS=
EXE=
HAVE_GETOPT_LONG=1
